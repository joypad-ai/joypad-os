...
// #define XINPUT_CONFIG_TOTAL_LEN  9 + (144 * USB_OUTPUT_PADS)
#define XINPUT_CONFIG_TOTAL_LEN  9 + (55 * USB_OUTPUT_PADS)
...
static const uint8_t xinput_config_descriptor[] = {
    ...
    (uint8_t)(0x02 * USB_OUTPUT_PADS),                               // bNumInterfaces
    ...
    // ---- Interface 2: Security (SubClass 0xFD, Protocol 0x13) ----
    ...
    // ---- Interface 3: Gamepad (SubClass 0x5D, Protocol 0x01) ----
    ...
    // EP 0x82 IN - Interrupt, 32 bytes, 1ms
    0x07, 0x05, 0x83, 0x03, 0x20, 0x00, 0x01,
    // EP 0x03 OUT - Interrupt, 32 bytes, 8ms
    0x07, 0x05, 0x04, 0x03, 0x20, 0x00, 0x08,

    // ---- Interface 4: Security (SubClass 0xFD, Protocol 0x13) ----
    // 0 endpoints, iInterface=7 (XSM3 security string)
    0x09, 0x04, 0x03, 0x00, 0x00, 0xFF, 0xFD, 0x13, 0x05,
    // Security descriptor (type 0x41, 6 bytes)
    0x06, 0x41, 0x00, 0x01, 0x01, 0x03,
#endif
};
