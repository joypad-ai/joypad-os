// profiles.h - BT2Loopy Profile Definitions
//
// Button mapping profiles for Bluetooth to Casio Loopy adapter.
...
#ifndef BT2LOOPY_PROFILES_H
#define BT2LOOPY_PROFILES_H
