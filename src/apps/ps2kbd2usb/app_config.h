/*
 * PS2KBD2USB LED Configuration
 * Defines player LED colors and patterns for the single keyboard "player".
 */

#ifndef CONSOLE_LED_CONFIG_H
#define CONSOLE_LED_CONFIG_H

// Player 1 - Cyan (PS/2 keyboard theme)
#define LED_P1_R 0
#define LED_P1_G 40
#define LED_P1_B 60
#define LED_P1_PATTERN 0b00100

// Players 2-7 never used (single input) but must be defined
#define LED_P2_R 0
#define LED_P2_G 0
#define LED_P2_B 64
