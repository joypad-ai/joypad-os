...
void app_init(void)
{
    ...
    printf("[app:neogeo2usb]   NEOGEO pins: B1=%d B2=%d B3=%d B4=%d B5=%d B6=%d\n",
           ARCADE_PIN_P1, ARCADE_PIN_P2, ARCADE_PIN_P3,
           ARCADE_PIN_K1, ARCADE_PIN_K2, ARCADE_PIN_K3);
     printf("[app:neogeo2usb]   NEOGEO pins: DU=%d DD=%d DL=%d DR=%d S1=%d S2=%d\n",
           ARCADE_PIN_DU, ARCADE_PIN_DD, ARCADE_PIN_DL,
           ARCADE_PIN_DR, ARCADE_PIN_S1, ARCADE_PIN_S2);
}
