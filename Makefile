...
.PHONY: ps2kbd2usb_kb2040
ps2kbd2usb_kb2040:
	$(call build_app,ps2kbd2usb_kb2040)
...
.PHONY: flash-ps2kbd2usb_kb2040
flash-ps2kbd2usb_kb2040:
	@$(MAKE) --no-print-directory _flash_app APP_NAME=ps2kbd2usb_kb2040
